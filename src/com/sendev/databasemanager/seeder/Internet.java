...
public class Internet extends Generator
{
    private final Name name;
    private final Lorem lorem;

    public Internet(ResolverContract resolver, Name name, Lorem lorem, FakeValuesServiceContract fakeValueService)
    {
    ...
    public String emailAddress(String localPart)
    {
        return join(new Object[]{
            localPart,
            "@",
            IDN.toASCII(service().fetchString("internet.free_email"))
        });
    }
    ...
    {
        return "https://s3.amazonaws.com/uifaces/faces/twitter/" + service().fetchString("internet.avatar");
    }
    ...
    public String image(Integer width, Integer height, Boolean gray, String text)
    {
        ...
        gray ? "g/" : StringUtils.EMPTY, width, height, service().fetchString("internet.image_category"),
