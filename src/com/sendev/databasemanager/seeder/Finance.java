...
public class Finance extends Generator
{
    ...
    {
        return creditCard(CreditCardType.values()[fakeValueService.getRandomService().nextInt(CreditCardType.values().length)]);
    }
    ...
    private String calculateIbanChecksum(String countryCode, String basicBankAccountNumber)
    {
