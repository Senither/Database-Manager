...
public class Blueprint implements DatabaseOriginLookup
{
    ...
    /**
     * The empty constructor is used by the {@link com.sendev.databasemanager.DatabaseFactory#getDynamicOrigin(java.lang.Class) }
     * method using the {@link DatabaseOriginLookup} contract, you should NEVER create a Blueprint without a table.
     *
     * @see #Blueprint(java.lang.String)
     */
    public Blueprint()
    {
        this.table = null;
     ...
     * @see Field#defaultValue(com.sendev.databasemanager.schema.DefaultSQLAction)
     */
